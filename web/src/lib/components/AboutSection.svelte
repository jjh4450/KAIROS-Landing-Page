	...
	const pillars: { idx: string; title: string; body: string }[] = [
		{
			idx: '01',
			title: 'Learn',
			body: '웹, 포너블, 리버싱, 암호 분야로 나뉜 정기 스터디를 운영합니다. 처음 시작하는 부원도 따라올 수 있도록 단계별 자료와 선배 멘토링을 제공합니다.'
		},
		{
			idx: '02',
			title: 'Compete',
			body: '국내외 CTF에 부원들이 함께 참여하고, 풀이(write-up)는 동아리 안에 모아 둡니다. 다음 학기 부원이 같은 자료에서 시작할 수 있도록 기록을 남깁니다.'
		},
		{
			idx: '03',
			title: 'Build',
			body: '학습 과정에서 만든 도구와 연구 결과를 정리해 오픈소스로 공개합니다.'
		},
		{
			idx: '04',
			title: 'Share',
			body: '교내 세미나와 KUCIS 활동에 참여하고, 가능한 자리에서는 외부 발표도 합니다.'
		}
	];
</script>

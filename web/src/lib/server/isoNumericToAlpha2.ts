// ISO 3166-1 numeric (3-digit) → alpha-2 매핑.
// world-atlas/countries-110m 의 feature.id 가 numeric 이라 alpha-2 로 변환 필요.
// 출처: https://en.wikipedia.org/wiki/ISO_3166-1_numeric
